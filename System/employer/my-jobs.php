...
<head>
	...
	<title>NSU Job Scopes - My Jobs</title>
									...
									<?php
                                        ...
                                        foreach($result as $row)
                                        {
										   ...
										   ?>
											...
											<p class="location"><i class="fa fa-map-marker text-primary"></i> <strong class="text-primary"></strong> <?php echo "$jobcity" ?></p>
